...
from backend.utils.users import get_user_profile_data, remove_user_token
...
class ChangePasswordView(UpdateAPIView):
    ...
    permission_classes = import_string_list(
        backend_settings.CHANGE_PASSWORD_PERMISSION_CLASSES)
    serializer_class = import_string(
        backend_settings.CHANGE_PASSWORD_SERIALIZER)
